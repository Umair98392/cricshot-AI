  ...
  return (
    <div className="sidebar-icons-container">
      ...
      <div className={`md:flex md:flex-col md:items-center md:relative ${showSidebar ? '' : 'hidden'}`}>
        <SideBarIcon icon={<FaUserCircle size="30" />} text="Profile" to="/ProfileDemo" />
        <Divider/>
        <SideBarIcon icon={<FiActivity size="30" />} text="Activity" to="/ActivityDemo" />
        <Divider/>
        <SideBarIcon icon={<BsGearFill size="30" />} text="Settings" to="/SettingDemo"  />
        <Divider/>
        <SideBarIcon icon={<FaHandsHelping size="30" />} text="Help" to="/HelpDemo" />
        <Divider/>
        <SideBarIcon icon={<BiLogOutCircle  size="30" />} text="Logout" to="#" onClick={null} />
      </div>
    </div>
  );
};
